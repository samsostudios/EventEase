...
(() => {
  ...
  var init_faq = __esm({
    "src/components/faq.ts"() {
      ...
      FAQ = class {
        ...
        answers;
        constructor() {
          this.component = document.querySelector("[data-faq-section]");
          this.items = [...this.component.querySelectorAll(".faq_item")];
          this.answers = [...this.component.querySelectorAll(".faq_item-a")];
          this.initUI();
          this.setListeners();
        }
        initUI() {
          gsapWithCSS.set(this.answers, { height: 0 });
        }
        setListeners() {
          this.items.forEach((item) => {
            ...
            item.addEventListener("click", () => {
              ...
              if (isOpen) {
                gsapWithCSS.to(getAnswer, { height: "0", ease: "power3.inOut" });
                gsapWithCSS.to(getIcon, { rotate: 180, ease: "power3.inOut" });
              } else {
                gsapWithCSS.to(getAnswer, { height: "auto", ease: "power3.inOut" });
                gsapWithCSS.to(getIcon, { rotate: 0, ease: "power3.inOut" });
              }
              isOpen = !isOpen;
            });
          });
  ...
  window.Webflow.push(() => {
    console.log("/// mainJS ///");
    initSmoothScroll();
    loadComponent_default("[data-faq-section]", () => Promise.resolve().then(() => (init_faq(), faq_exports)));
  });
})();
